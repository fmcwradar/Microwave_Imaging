...
class radar_measurement_evaluation:
    ...
    INPUTS:
        ...
        measurement_offset: (float) absolute z-value of the corresponding plane. Only necessary if you want to evaluate measurement data of one 3D scan in multiple folders.
    """
    
    def __init__(self,path_csv,name,B,T_c,c0,number_of_ramps,total,f0,f1,windowing,ideal,swap_IQ,calibration,plotting,filtering,fc_low,fc_high,filterorder,measurement_offset):
        self.path = path_csv
        self.name = name
        self.bandwidth = B
        self.chirp_time = T_c
    ...
    def average_data_calculate_FTT(self):
        ...
        if self.calibration == "True":
            ...
            with open(r"{0}\Pickle Files\error_function_radar.pkl".format(current_dir), 'rb') as pickle_file:
        ...
        filepath = r"{0}\Pickle Files for 3D Imaging\{1}.pkl".format(current_dir,str(corrected_name[:-4]))
        ...
        filepath = r"{0}\Pickle Files for 3D Imaging\distance.pkl".format(current_dir)
