...
path = pathlib.Path(r'{0}\Ideal_Data_VNA'.format(current_dir))
...
for antenna_location in antenna_positions:
    ...
    mlin_length.write_touchstone(r"{0}\Ideal_Data_VNA\0.0_{1}.s2p".format(current_dir,float(counter*10)), r_ref = 50)
